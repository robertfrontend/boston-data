...
export const Footer: React.FC = () => {
  return (
    <footer className="max-w-lg mx-auto px-5 py-12 text-center space-y-4">
      <div className="flex items-center justify-center gap-2 text-app-secondary-text font-medium text-sm">
        <a 
          href="https://linkedin.com/in/robertfrontend" 
          target="_blank" 
          rel="noopener noreferrer"
          className="hover:text-system-blue transition-colors flex items-center gap-1"
        >
          <span>Created with</span>
          <Heart className="w-3.5 h-3.5 fill-system-red text-system-red" aria-hidden="true" />
        ...
        <a 
          ...
          target="_blank" 
          rel="noopener noreferrer"
          className="flex items-center gap-1.5 hover:text-system-blue transition-colors"
        >
